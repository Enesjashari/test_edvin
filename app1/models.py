...
class Informations(models.Model):
    ...
    preffix=models.CharField(max_length = 20,blank=True,null=True,choices=DEGREE_CHOICES, verbose_name='Preffix',db_column="Prefix")
    suffix=models.CharField(max_length = 20,blank=True,null=True,choices=DEGREE_CHOICES, verbose_name='Suffix',db_column="Sufix")
    ...
    phone=models.CharField(max_length=10,blank = True,  null=True, verbose_name='Phone',db_column="Phone")
    otherphone=models.CharField(max_length=10,blank = True,  null=True, verbose_name='Other Phone',db_column="Other Phone")
    address=models.CharField(max_length=100,blank = True,  null=True, verbose_name='Address',db_column="Address")
    city=models.CharField(max_length=20,blank = True,  null=True, verbose_name='City',db_column="City")
    stateprovince=models.CharField(max_length=15,blank = True,  null=True,choices=COUNTRY_CHOICES, verbose_name='State/Province',db_column="State/Province")
    zipcode=models.CharField(max_length=5,blank = True,  null=True, verbose_name='Zip Code',db_column="ZCode")
    ...
    mailaddress=models.CharField(max_length=100,blank = True,  null=True, verbose_name='Mailing Address',db_column="Mailing Address")
    mailcity=models.CharField(max_length=100,blank = True,  null=True, verbose_name='Mailing City',db_column="Mailing City")
    mailingstateprovince=models.CharField(max_length=100,blank = True,choices=COUNTRY_CHOICES,  null=True, verbose_name='Mailing State/Province',db_column="Mailing State/Province")
    mailingzipcode=models.CharField(max_length=5,blank = True,  null=True, verbose_name='Mailing Zip Code',db_column="Mailing Zip Code")
    mailingcountry=models.CharField(max_length=100,blank = True,  null=True, verbose_name='Mailing Country',db_column="Mailing Country")
    birthcity=models.CharField(max_length=100, blank = True, null=True, verbose_name='Birth City',db_column="Birth City")
    birthcountry=models.CharField(max_length=100,blank = True,  null=True, verbose_name='Birth Country',db_column="Birth Country")
    birthstateprovince=models.CharField(max_length=100,blank = True, choices=COUNTRY_CHOICES ,null=True, verbose_name='Birth State/Province',db_column="Birth State/Province")
    npinumber=models.CharField(max_length=100,blank = True,  null=True, verbose_name='NPI NUMBER',db_column="NPI Number")
    languagesspokenotherthanenglish=models.CharField(max_length=100,blank = True,  null=True, verbose_name='Languages  Spoken other than English',db_column="Other Languages") #this has to be done otherwa,db_column=""y
    emergencycontactname=models.CharField(max_length=100,blank = True,  null=True, verbose_name='Emergency Contact Name',db_column="Emergency Name")
    relationshiptoapplicant=models.CharField(max_length=100,blank = True,  null=True, verbose_name='Relationship To Applicant',db_column="Relationship To Applicant")
    emergencycontactnumber=models.CharField(max_length=100,blank = True,  null=True, verbose_name='Emergency Contact Number',db_column="Emergency Number")
    emergencycontactemail=models.CharField(max_length=100,blank = True,  null=True, verbose_name='Emergency Contact Email',db_column="Emergency Email")
    primaryspeciality=models.CharField(max_length=100,blank = True,  null=True, verbose_name='Primary Speciality',db_column="Primary Speciality")
    generalsurgery=models.CharField(max_length=100, blank = True, null=True, verbose_name='General Surgery',db_column="General Surgery")
    secondaryspeciality=models.CharField(max_length=100,blank = True,  null=True, verbose_name='Secondary Speciality',db_column="Secondary Speciality")
    ...
    workauthorizationa = models.CharField(max_length=100, blank = True, null=True,choices=DEGREE_CHOICES, verbose_name='Work Authorization' ,db_column="Work Auth")
